            ...
            <ul class="flex flex-col pl-0 mb-0">
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 bg-blue-500/13 dark:text-white dark:opacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors"
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Position</span>
                    </a>
                </li>
            </ul>
        </div>
                ...
                <nav>
                    ...
                    <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        ...
                        <li class="text-sm pl-2 capitalize leading-normal text-white before:float-left before:pr-2 before:text-white before:content-['/']"
                            aria-current="page">Kontrak</li>
                    </ol>
                    <h6 class="mb-0 font-bold text-white capitalize">Kontrak</h6>
                </nav>
            </div>
        </nav>
        <!-- end navbar -->
                ...
                <div class="flex-none w-full max-w-full px-3">
                    <div
                        ...
                        <div
                            ...
                            <h6 class="dark:text-white">Daftar Tipe Kontrak</h6>
                            <a href="javascript:;"
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <h6 class="mb-0 text-sm leading-normal dark:text-white">
                                                        {{ $contract->contract_type }}</h6>
                                                </td>
                                                <td
                                                    class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                    <a href="javascript:;"
                                                        onclick="openEditSwal('{{ $contract->id }}', '{{ $contract->contract_type }}')"
                                                        class="text-blue-500">Edit</a> |
                                                    <button type="button" onclick="confirmDelete({{ $contract->id }})"
...
<script>
    function openCreateSwal() {
        Swal.fire({
            ...
            html: `
            <input id="swal-input-create" class="swal2-input" placeholder="Nama Kontrak">
        `,
            ...
            preConfirm: () => {
                const name = document.getElementById('swal-input-create').value.trim();

                if (!name) {
                    Swal.showValidationMessage('Tipe kontrak tidak boleh kosong');
                    return false;
                }

                return fetch(`{{ route('contracts.store') }}`, {
                    method: 'POST',
                    headers: {
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    title: 'Berhasil!',
                    text: 'Tipe kontrak berhasil ditambahkan.',
                    icon: 'success',
    ...
    function openEditSwal(id, name) {
        Swal.fire({
            title: 'Edit Tipe Kontrak',
            html: `
            <input id="swal-input1" class="swal2-input" value="${name}" placeholder="Tipe Kontrak">
        `,
            showCancelButton: true,
            confirmButtonText: 'Simpan',
            cancelButtonText: 'Batal',
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    title: 'Berhasil!',
                    text: 'Tipe Kontrak berhasil diperbarui.',
                    icon: 'success',
                    confirmButtonText: 'OK',
                    customClass: {
                        confirmButton: 'bg-blue-500 hover:bg-blue-600 text-white font-medium px-4 py-2 rounded'
